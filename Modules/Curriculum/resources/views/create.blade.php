<x-layouts::app :title="__('Create Curriculum')">
    <div class="p-4">

        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="border-b border-gray-200 px-6 py-4 bg-gray-50 rounded-t-lg">
                <h4 class="text-lg font-semibold text-gray-900 mb-0">Create Curriculum</h4>
            </div>
            ...
            <form action="{{ route('curriculum.store') }}" method="POST">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <flux:select name="status" label="Status">
                        ...
                        <flux:select.option value="dismissed" :selected="old('status') === 'dismissed'">Dismissed
                        </flux:select.option>
                    </flux:select>
                </div>
