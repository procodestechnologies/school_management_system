    ...
    <div class="p-4">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="border-b border-gray-200 px-6 py-4 bg-gray-50 rounded-t-lg">
                <h4 class="text-lg font-semibold text-gray-900 mb-0">Create Teacher</h4>
            </div>

            @if ($errors->any())
                <div class="mx-6 mt-4 rounded-md border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">
                    <p class="font-medium">{{ $errors->count() }} error(s) prevented this teacher from being saved:</p>
            ...
            <form action="{{ route('teacher.store') }}" method="POST">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        ...
                        <flux:input type="email" name="email" label="Email" value="{{ old('email') }}"
                            required />
                        <flux:input type="password" name="password" label="Password" required />
                    </div>
                ...
                <div class="border-t border-gray-200 px-6 py-4 bg-gray-50 rounded-b-lg flex justify-end gap-3">
                    ...
                    <flux:button variant="primary" type="submit">Save Teacher</flux:button>
                </div>
            </form>
        </div>
    </div>
