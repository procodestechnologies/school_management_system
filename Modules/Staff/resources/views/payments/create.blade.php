<x-layouts::app :title="__('Record Staff Payment')">
    <div class="p-4">

        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="border-b border-gray-200 px-6 py-4 bg-gray-50 rounded-t-lg">
                <h4 class="text-lg font-semibold text-gray-900 mb-0">Record Staff Payment</h4>
            </div>
            ...
            @include('staff::payments.form', [
                'action' => route('staff.payments.store'),
                'method' => 'POST',
                'submitLabel' => __('Save Payment'),
            ])
        </div>
    </div>
</x-layouts::app>
