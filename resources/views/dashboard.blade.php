        ...
        @elseif ($scope === 'system')
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <flux:card class="space-y-1">
                    ...
                    <flux:text class="text-xs text-zinc-500">{{ $stats['active_institutions_count'] }} active
                    </flux:text>
                </flux:card>
                <flux:card class="space-y-1">
                ...
                <flux:card class="lg:col-span-2">
                    ...
                    <flux:table>
                        ...
                        <flux:table.rows>
                                ...
                                <flux:table.row>
                                    <flux:table.cell>
                                        <a href="{{ route('institution.show', $institution->id) }}"
                                            class="hover:underline">{{ $institution->name }}</a>
                                    </flux:table.cell>
                            ...
                            @empty
                                <flux:table.row>
                                    <flux:table.cell colspan="3" class="text-center text-zinc-500">No institutions
                                        yet.</flux:table.cell>
                                </flux:table.row>
                            @endforelse
                        </flux:table.rows>
            ...
            <div class="flex flex-wrap gap-3">
                @can('create institution')
                    <flux:button href="{{ route('institution.create') }}" icon="building-library">Add
                        Institution</flux:button>
                @endcan
                <flux:button href="{{ route('admin.modules.index') }}" icon="rectangle-stack" variant="ghost">Manage
                    Modules</flux:button>
            </div>
